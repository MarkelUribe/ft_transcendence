...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.sentFriendships, { onDelete: 'CASCADE' }),
    __metadata("design:type", user_entity_1.User)
], Friendship.prototype, "requester", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.receivedFriendships, { onDelete: 'CASCADE' }),
    __metadata("design:type", user_entity_1.User)
